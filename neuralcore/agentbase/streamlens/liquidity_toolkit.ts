 ...
 * – future extensions: price impact, arbitrage viability, impermanent loss analysis
 */
...
/**
 * Helper to list all registered liquidity tool keys
 */
...
/**
 * Resolve a liquidity tool by key
 */
